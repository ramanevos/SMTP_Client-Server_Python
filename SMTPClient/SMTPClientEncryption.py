...
"""class used to encrypt/decrypt the client"""
...
class Encryption:
    def __init__(self, base, modulus):
        """ Encryption variable initialization"""
        # public variables
        self.method = None
        # protected variables
        self._enabled = False
    ...
    def generate_public_key(self):
        """calculate and return the public key for the client"""
    ...
    def generate_shared_key(self, server_public_key):
        """calculate and return the shared key"""
        shared_key = int(server_public_key) ** self._private_key
